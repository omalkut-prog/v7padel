...
## Что **жду от тебя** для следующего шага

1. **login.html** — Вариант A (просто новые пароли) / B (Google OAuth) / C (Supabase)?
2. **intensive.html** — оптимизировать (1.5ч) или оставить?
3. **12 role-заглушек** — удалить (5 мин) / наполнить (>20ч) / оставить как есть?

Когда ответишь — сделаю. Что-то одно или всё за раз — на твой выбор.
