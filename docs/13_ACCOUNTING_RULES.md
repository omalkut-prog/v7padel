...
Случай Bob Camp (2026-04-17):
- 1GDRZ Income 15.04 · `Tournaments / Other tournaments 140 000 ₺` (без комментария, без клиента) — ошибочная запись.
- `manual_entries` 16.04 · `Camp / Intensive · Bob Camp 19-25.04 · 140 000 ₺` (с комментом, с именем Bob Odilov, source=`bob_camp_apr19`) — истина.
- Фикс: удалить строку в 1GDRZ + добавить compensating-запись в manual_entries на 15.04 с `amount = -140 000` (см. «Correction entries» ниже).
